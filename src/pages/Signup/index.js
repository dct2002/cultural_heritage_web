            ...
            <div className="max-w-sm mx-auto">
                ...
                <div className="flex flex-wrap -mx-3">
                  <div className="w-full px-3">
                    <button className="btn px-0 text-white bg-red-600 hover:bg-red-700 w-full relative flex items-center">
                      ...
                      <span className="flex-auto pl-16 pr-8 -ml-16">Tiếp tục với Google</span>
                    </button>
                  </div>
                </div>
              </form>
              ...
              <form>
                <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="full-name">Họ tên <span className="text-red-600">*</span></label>
                    <input id="full-name" type="text" className="form-input w-full text-gray-300" placeholder="Nhập họ và tên" required />
                  </div>
                </div>
                {/* <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                ...
                <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    ...
                    <input id="password" type="password" className="form-input w-full text-gray-300" placeholder="Mật khẩu (ít nhất 6 kí tự)" required />
                  </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="password">Nhập lại mật khẩu <span className="text-red-600">*</span></label>
